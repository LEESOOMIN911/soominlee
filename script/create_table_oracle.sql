...
COMMENT ON COLUMN MCARE_MENU.REAUTH_LEVEL  IS '재인증 필요한 메뉴에 대한 재인증 수단'; 
...
---   P_NAME               	VARCHAR2 (255),
   ...
   EXTERNAL_ID_VALUE 		VARCHAR2 (255), 
...
COMMENT ON COLUMN MCARE_USER.EXTERNAL_ID_VALUE IS '사용자 외부 Key '; 
