...
@Controller
@RequestMapping("/mobile/healthHandbook")
@ServiceMenu(menuId="healthHandbook", description="건강수첩")
public class HealthHandbookController  extends AbstractController {
	 ...
	 */
	@RequestMapping(value = "/personalInfo.json", method = RequestMethod.POST)
	@ResponseBody
	public Map<String, Object> getPersonalHealthInfo(HttpServletRequest request, HttpServletResponse response, 
		...
		try { 
			// api 호출
			return this.apiCallService.call(PnuhApi.TOTALEXAM_GETPERSONHEALTHINFO, reqMap); 
		}
