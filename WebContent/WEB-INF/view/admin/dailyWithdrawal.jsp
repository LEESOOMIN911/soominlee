...
<script type="text/javascript" src="<c:url value='/resources/js/admin/dailyWithdrawal.js' />"></script>
<!-- 날짜별 탈퇴현황 -->
<div class="main-wrapper">
	<div class="k-header title-bar">
    	<span class="k-icon k-i-group"></span>
    	<span class="title">일자별 탈퇴현황</span>
...
$(document).ready(function () {
	var dailyWithdrawal = new mcare_admin_dailyWithdrawal();
	dailyWithdrawal.init();
});
</script>
