...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/mobile/agreement/agreement.css"/>" />
<script type="text/javascript" src="<c:url value='/resources/js/mobile/agreement/agreement.js' />"></script>
<!-- 동의서 -->
...
$(document).on("pagebeforeshow", function(e, ui) {
	var agreement = new mcare_mobile_agreement();
	agreement.init();
});
