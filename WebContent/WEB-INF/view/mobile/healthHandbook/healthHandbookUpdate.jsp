...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/mobile/healthHandbook/healthHandbookUpdate.css"/>" />
<script type="text/javascript" src="<c:url value='/resources/js/mobile/healthHandbook/healthHandbookUpdate.js' />"></script>
<!-- 건강수첩 -->
        ...
        <div class="sec_con">
	        <div class="ui-grid-a">
	            ...
	            <div class="ui-block-b">
	                <a href="#" id="remove" class="ui-btn ui-corner-all ui-btn-b" ><s:message code='mobile.view.common002'/></a>
	            </div>
	        </div>
        </div>        
	</div>
...
var i18n = function(){
	var message = {
		...
		"healthHandbookInsert029" : "<s:message code='mobile.message.healthHandbookInsert029'/>"
	};
...
$(document).on("pagebeforeshow", function(e, ui) {
	var healthHandbookUpdate = new mcare_mobile_healthHandbookUpdate();
	healthHandbookUpdate.setGlobal( healthHandbookUpdate );
	healthHandbookUpdate.init();
});
