...
<div data-role="content">
	...
	<div>
		<h3 class="subTitle"> <i class="fa fa-info-circle"></i>&nbsp;<s:message code="mobile.view.resetPWD016"/></h3>
	</div>
	<input type="password" id="pass1" placeholder="<s:message code="mobile.view.resetPWD001"/>"/>
	<div>
